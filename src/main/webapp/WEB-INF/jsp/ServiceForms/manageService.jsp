        ...
        <section class="col-md-12">
            <div class="container" style="margin-top: 150px">
                <div class="row" style="margin-bottom: 50px" >
                    <h1 style="text-align: center; margin:  0 auto;">Alteração de Serviço</h1>
                </div>
                <div class="row">
                    <div class="col-md-4" style="margin: 0 auto;">
                        <form name="send" action="${pageContext.request.contextPath}/manageService" method="get">
                            <input type="number" name="idServ" value="${serv.id}" style="visibility: hidden">
                            <div class="form-group">
                                <label for="formGroupExampleInput">Nome do Serviço</label>
                                <input type="text" class="form-control" value="${serv.nome}" id="nome" name="nome" placeholder="Nome">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Preço</label>
                                <input type="number" value="${serv.valor}" class="form-control" id="valor" name="valor"  placeholder="Preço">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pet" value="${serv.pet}" name="pet"  placeholder="Pet">
                            </div>
