        ...
        <section class="col-md-12">
            <div class="container" style="margin-top: 150px">
                <div class="row" style="margin-bottom: 50px" >
                    <h1 style="text-align: center; margin:  0 auto;">Alteração de Cliente</h1>
                </div>
                <div class="row">
                    <div class="col-md-4" style="margin: 0 auto;">
                        <form name="send" action="${pageContext.request.contextPath}/manageCliente" method="get">
                            <input type="number" name="idCliente" value="${cliente.id}" style="visibility: hidden">
                            <div class="form-group">
                                <label for="formGroupExampleInput">Nome</label>
                                <input type="text" class="form-control" value="${cliente.nome}" id="nomeCli" name="nomeCli" placeholder="NOME">
                            </div>
                            <!--<div class="form-group">
                                <label for="formGroupExampleInput2">Data de Nascimento</label>
                                <input type="date" class="form-control" id="dataNasc" name="dataNasc" value="${cliente.dataNasc}" placeholder="112223334">
                            </div>-->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="${cliente.rg}" id="rgCli" name="rgCli" placeholder="112223334">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">CPF</label>
                                <input type="text" class="form-control" value="${cliente.cpf}" id="cpfCli" name="cpfCli"  placeholder="11122233344">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Endereço</label>
                                <input type="text" class="form-control" value="${cliente.endereco}" id="enderecoCli" name="enderecoCli"  placeholder="11122233344">
                            </div>
