            ...
            <div class="container" style="margin-top: 150px">
                ...
                <div class="row">
                    <div class="col-md-4" style="margin: 0 auto;">
                        <form action="${pageContext.request.contextPath}/searchCliente" method="get">
                        ...
                        <form name="send" action="${pageContext.request.contextPath}/searchCliente" method="post">
                            <table>     
                            ...
                            <input type="text" id="idCliente"  name="idCliente1" value="" style="visibility: hidden">
                            <script>
                                function hdnID(a) {
                                    document.getElementById("idCliente").value = a;
