        ...
        <section class="col-md-12">
            <div class="container" style="margin-top: 150px">
                <div class="row" style="margin-bottom: 50px" >
                    <h1 style="text-align: center; margin:  0 auto;">Cadastro Produto</h1>
                </div>
                <div class="row">
                    <div class="col-md-4" style="margin: 0 auto;">
                        <form name="send" action="${pageContext.request.contextPath}/product" method="post">
                            <div class="form-group">
                              <label for="formGroupExampleInput">Nome do Produto</label>
                              <input type="text" class="form-control" id="nomeProd" name="nomeProd" placeholder="NOME">
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Valor</label>
                              <input type="text" class="form-control" id="uniValue" name="uniValue"  placeholder="VALOR UNITÁRIO">
                            </div>
                            <div class="form-group">
